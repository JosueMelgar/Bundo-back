...
db.execute('CREATE TABLE users(userid INTEGER PRIMARY KEY AUTOINCREMENT,name TEXT NOT NULL, lastname TEXT NOT NULL, phone INT NOT NULL UNIQUE, email TEXT NOT NULL UNIQUE, password TEXT NOT NULL)')
